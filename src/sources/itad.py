...
# The reliable RSS feed URL for IsThereAnyDeal
...
class ITADSource(BaseWebClient):
    """Fetches deals from IsThereAnyDeal.com using its reliable RSS feed via aiohttp."""

    def __init__(self, session: aiohttp.ClientSession, cache_ttl: int = 900): # 15 minute TTL for RSS
        super().__init__(
    ...
    async def fetch_free_games(self) -> List[GameData]:
        ...
        # Use the robust _fetch method from BaseWebClient
